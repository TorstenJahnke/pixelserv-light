...
// NOTE: VERSION is now defined in version.h
...
#define DEFAULT_PORT "1080"     // the default port users will be connecting to
...
#include "certs/certs.h"          // <- WICHTIG: vor pixel_cert_pipe!
#include <stddef.h>         // <- für size_t
#include <errno.h>
#include <netdb.h>
...
/* NOTE: FEATURE_FLAGS and FEAT_* are now defined in version.h */
